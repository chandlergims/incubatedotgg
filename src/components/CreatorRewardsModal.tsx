      ...
      >
        <div className="p-6">
              ...
              <div className="space-y-2 text-[9px]">
                <div className="grid grid-cols-6 gap-2 items-center py-1 bg-green-50 rounded">
                  <div className="flex items-center gap-1">
                    <img src="/Untitled design (60).png" alt="incubate.gg" className="w-3 h-3 rounded object-cover" />
                    <span className="font-medium text-[8px] text-green-800">incubate.gg</span>
                  </div>
          ...
          <div className="space-y-2 text-gray-800 text-sm leading-relaxed mb-4">
            <p>
              <strong>incubate.gg</strong> offers the highest creator rewards - up to 90% of trading fees generated from the LP.
            </p>
            <p>
