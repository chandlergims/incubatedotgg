          ...
          <div className="space-y-8 text-gray-700 leading-relaxed">
            <section>
              ...
              <ul className="list-disc list-inside space-y-2">
                ...
                <li><strong>Transaction Data:</strong> On-chain transaction history and token interactions</li>
                <li><strong>Usage Analytics:</strong> Anonymous usage patterns to improve platform performance</li>
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2">
                ...
                <li>To process blockchain transactions and token operations</li>
                ...
                <li>To communicate important platform updates or security notices</li>
              </ul>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2">
                <li><strong>Blockchain Transparency:</strong> Transaction data is publicly visible on the Solana blockchain</li>
                <li><strong>Service Providers:</strong> Trusted third-party services that help us operate the platform</li>
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2">
                ...
                <li>Secure hosting infrastructure and backup systems</li>
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2">
                <li><strong>Solana Blockchain:</strong> For transaction processing and token operations</li>
                <li><strong>Meteora:</strong> For liquidity provision and trading functionality</li>
                <li><strong>Wallet Providers:</strong> For connecting and managing cryptocurrency wallets</li>
            ...
            <section>
              ...
              <p>
                We retain your information for as long as necessary to provide our services and comply with legal obligations. Blockchain transaction data is permanently recorded on the Solana network and cannot be deleted. Other data may be retained for varying periods based on its purpose and legal requirements.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Our platform is not intended for use by individuals under the age of 18. We do not knowingly collect personal information from children. If we become aware that we have collected information from a child, we will take steps to delete such information.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                If you have any questions about this Privacy Policy or our data practices, please contact us through our official communication channels. We will respond to your inquiries in a timely manner.
              </p>
            </section>
          </div>
