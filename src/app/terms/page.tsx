        ...
        <div className="p-8">
          ...
          <div className="space-y-8 text-gray-300 leading-relaxed">
            <section>
              ...
              <p>
                By accessing and using incubate.gg (the "Platform"), you accept and agree to be bound by the terms and provision of this agreement. If you do not agree to abide by the above, please do not use this service.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                metpad.fun is an AI agent launchpad that enables users to create, tokenize, and trade AI agent concepts on the Solana blockchain. The platform utilizes dynamic bonding curve mechanisms to provide fair price discovery and guaranteed liquidity for AI agent tokens.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mb-4">
                <strong className="text-white">High Risk Warning:</strong> Trading cryptocurrencies and using DeFi platforms involves substantial risk of loss. You should carefully consider whether such trading is suitable for you in light of your financial condition.
              </p>
              <ul className="list-disc list-inside space-y-2">
            ...
            <section>
              <h2 className="text-xl font-semibold text-white mb-4">5. Platform Fees</h2>
              <p>
                The platform operates on a dynamic bonding curve mechanism with transparent fee structures. Creator fees are distributed based on token performance and community engagement, supporting the development and maintenance of AI agents.
              </p>
            </section>
